      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 font-dm-sans text-xs tracking-[0.2em] uppercase text-rose-blue hover:text-zari-gold transition-colors duration-300"
          >
