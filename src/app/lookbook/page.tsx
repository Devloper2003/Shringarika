...
const lookbookImages = [
  { id: 1, category: 'Bridal', aspect: 'aspect-[3/4]', gradient: 'from-rose-gold-light/40 via-blush to-champagne', letter: 'B', title: 'Maharani Bridal' },
  { id: 2, category: 'Festive', aspect: 'aspect-square', gradient: 'from-champagne via-sandalwood to-blush', letter: 'F', title: 'Mehfil Night' },
  { id: 3, category: 'Bridal', aspect: 'aspect-[4/5]', gradient: 'from-blush-warm via-rose-gold-light/30 to-champagne', letter: 'R', title: 'Royal Reception' },
  { id: 4, category: 'Western', aspect: 'aspect-[3/4]', gradient: 'from-ivory-dark via-champagne to-sandalwood', letter: 'W', title: 'Fusion Silhouette' },
  { id: 5, category: 'Atelier', aspect: 'aspect-square', gradient: 'from-noir-soft via-mauve-dusty/20 to-noir', letter: 'A', title: 'Behind the Needle' },
  { id: 6, category: 'Campaign', aspect: 'aspect-[4/5]', gradient: 'from-sandalwood/80 via-champagne to-blush', letter: 'C', title: 'Spring/Summer 2025' },
  { id: 7, category: 'Festive', aspect: 'aspect-[3/4]', gradient: 'from-blush via-rose-gold-light/20 to-champagne', letter: 'D', title: 'Diwali Glamour' },
  { id: 8, category: 'Bridal', aspect: 'aspect-square', gradient: 'from-champagne/60 via-blush to-sandalwood', letter: 'V', title: 'Varanasi Vows' },
  { id: 9, category: 'Atelier', aspect: 'aspect-[4/5]', gradient: 'from-noir via-noir-soft to-mauve-dusty/30', letter: 'S', title: 'Silk & Story' },
  { id: 10, category: 'Western', aspect: 'aspect-[3/4]', gradient: 'from-ivory-dark via-champagne to-blush', letter: 'I', title: 'Indo-Modern' },
  { id: 11, category: 'Campaign', aspect: 'aspect-square', gradient: 'from-champagne via-sandalwood/80 to-rose-gold-light/30', letter: 'H', title: 'Heritage Film' },
  { id: 12, category: 'Festive', aspect: 'aspect-[4/5]', gradient: 'from-blush-warm via-champagne to-sandalwood', letter: 'N', title: 'Navratri Nights' },
];
...
const behindTheScenes = [
  ...
  { title: 'Dyeing Unit', gradient: 'from-noir via-mauve-dusty/20 to-noir-soft', letter: 'D' },
  { title: 'Pattern Cutting', gradient: 'from-noir-soft via-noir to-mauve-dusty/10', letter: 'P' },
  { title: 'Final Fitting', gradient: 'from-noir to-noir-soft', letter: 'F' },
  { title: 'Fabric Selection', gradient: 'from-mauve-dusty/20 via-noir to-noir-soft', letter: 'S' },
  { title: 'Embellishment', gradient: 'from-noir-soft via-mauve-dusty/30 to-noir', letter: 'E' },
];
          ...
          <div className="columns-2 md:columns-3 gap-4 md:gap-6">
            {filteredImages.map((image, index) => (
              <FadeInSection key={image.id} delay={index * 0.06} className="break-inside-avoid mb-4 md:mb-6">
                <div className={`group relative ${image.aspect} bg-gradient-to-br ${image.gradient} rounded-sm overflow-hidden cursor-pointer`}>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="font-cormorant text-noir/10 text-7xl md:text-8xl italic group-hover:scale-110 transition-transform duration-700">{image.letter}</span>
                  </div>
                  {/* Hover Overlay */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            <div className="text-center mb-16">
              ...
              <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-noir mb-6">Bridal Stories</h2>
            ...
            {bridalStories.map((story, index) => (
              <FadeInSection key={story.name} delay={index * 0.15}>
                <div className="group cursor-pointer">
                  <div className={`aspect-[3/4] bg-gradient-to-br ${story.gradient} rounded-sm overflow-hidden mb-4`}>
                    <div className="w-full h-full flex items-center justify-center group-hover:scale-105 transition-transform duration-700">
                      <span className="font-cormorant text-noir/10 text-8xl italic">{story.letter}</span>
                    </div>
                  </div>
                  <p className="font-cormorant text-lg italic text-noir/70 leading-relaxed mb-3">&ldquo;{story.quote}&rdquo;</p>
                  <p className="font-cinzel text-sm text-noir tracking-wider">{story.name}</p>
                  <p className="font-dm-sans text-xs text-noir/40">{story.location}</p>
                </div>
              </FadeInSection>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {behindTheScenes.map((item, index) => (
              <FadeInSection key={item.title} delay={index * 0.1}>
                <div className="group cursor-pointer">
                  <div className={`aspect-square bg-gradient-to-br ${item.gradient} rounded-sm overflow-hidden`}>
                    <div className="w-full h-full flex items-center justify-center group-hover:scale-105 transition-transform duration-700">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-3 border border-zari-gold/40 text-zari-gold font-dm-sans text-xs tracking-[0.2em] uppercase hover:bg-zari-gold hover:text-noir transition-all duration-500"
            >
